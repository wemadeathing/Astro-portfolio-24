import { c as createComponent, a as renderTemplate, r as renderComponent, m as maybeRenderHead, b as addAttribute } from '../chunks/astro/server_D7IckMtV.mjs';
import 'kleur/colors';
...
</p> <form id="contact-form" class="space-y-4" method="POST"> <!-- Add the Web3Forms access key --> <input type="hidden" name="access_key"${addAttribute(undefined                                    , "value")}> <!-- Keep your existing form fields --> <div> <label for="name" class="block text-sm font-medium text-foreground mb-2">
Name
