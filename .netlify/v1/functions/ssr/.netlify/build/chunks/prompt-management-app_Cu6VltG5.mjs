    ...
    children: [createVNode(_components.h2, {
      ...
      children: [createVNode("div", {
        ...
        children: [createVNode("div", {
          ...
          class: "relative z-10",
          children: "Building a responsive app with a range of integrations that work together."
        })]
      })]
    }), createVNode(_components.h2, {
      ...
      class: "list-none space-y-3 [&>li]:before:content-['•'] [&>li]:before:text-purple-600 [&>li]:before:mr-2 [&>li]:flex",
      children: [createVNode("li", {
        children: "Prompt Library - Organize and categorize AI prompts with AI auto-tagging and search functionality"
      }), createVNode("li", {
        children: "AI-Powered Features - Built-in AI capabilities using Claude API for auto-tagging and organising prompts"
      }), createVNode("li", {
        ...
        children: "Responsive Design - Built with Astro and React islands for optimal performance and developer experience"
      }), createVNode("li", {
        children: "Database Management - Supabase for storing and managing prompt data and authentication"
      })]
    }), createVNode(_components.h2, {
      id: "results--impact",
      ...
      children: [createVNode("div", {
        ...
        children: [createVNode("div", {
          ...
          class: "relative z-10",
          children: "Used Astro framework, React islands architecture, and Chrome extension development in one project."
        })]
      }), createVNode("div", {
        class: "relative overflow-hidden rounded-xl bg-card p-6 border border-primary/40",
        children: [createVNode("div", {
          ...
          class: "relative z-10",
          children: "Successfully integrated multiple APIs (Claude, Supabase, Resend, Strapi) into a cohesive platform."
        })]
      }), createVNode("div", {
        class: "relative overflow-hidden rounded-xl bg-card p-6 border border-primary/40",
        children: [createVNode("div", {
      ...
      children: [createVNode("li", {
        ...
        children: "Branding and product design skills are extremely valuable when building with AI"
      })]
    }), createVNode(_components.p, {
      children: [createVNode(_components.strong, {
        children: "Timeline:"
      }), " 3 weeks", createVNode(_components.br, {}), "\n", createVNode(_components.strong, {
        children: "Status:"
