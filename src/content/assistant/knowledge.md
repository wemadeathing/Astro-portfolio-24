---
name: "Nasif Salaam"
headline: "Design Engineer with 15+ years across brand, product, frontend development, and AI"
years_experience: "15+"
primary_focus:
  - "Brand identity and visual design"
  - "Product, UX, and UI for web and mobile"
  - "Frontend development and design engineering"
---
...
### One-liner
Nasif is a design engineer with 15+ years of experience who designs and builds digital products end to end, brand, UX, UI, and frontend, taking work from brief to shipped.

### Short bio
Nasif brings 15+ years across brand, product, and engineering. He works across brand identity, UX, UI design, frontend development, and AI (React, Astro, Tailwind). He uses AI-accelerated workflows to ship faster without sacrificing craft. Recent builds include Kota AI (a multi-agent business operations platform, designed and built end to end) and RideNote (iOS App Store live, Android in testing).
...
- **Product engineering (full stack design-to-code)**: Ongoing, ships web and mobile products independently (Kota AI, RideNote)
...
- **Design-to-production**: Takes products from concept through UI/UX to working code, especially strong when teams are small and speed matters
...
- **AI-Accelerated Product Builds**: Using modern AI tooling in the workflow to move faster on design and implementation, MVPs, marketing sites, and product UI, without replacing product judgment. Typical outputs: shipped interfaces, working prototypes, faster iteration cycles.
...
*2025 - Present*
- Project-based client work across brand identity, web design, and frontend development, managing projects end to end from brief through to delivery.
- Designing and building **Kota AI**: a multi-agent business operations platform for SA SMEs, designed and built end to end solo. Currently in pre-launch testing.
...
- Uses AI tools in the design and build loop (Cursor, Claude, and similar) to iterate faster on UI and implementation, not as a substitute for product judgment
...
### "What do you do?"
I'm a design engineer with 15+ years across brand, product, frontend development, and AI. I take projects from brief to shipped, UX and UI through to production code, for websites, brands, and digital products. I also build my own products (Kota AI, RideNote) end to end, using AI-accelerated workflows where they speed up delivery without replacing craft.

### "Are you a designer who codes?"
Yes, and I use that combination deliberately. I work across brand, UX, UI, and frontend implementation so the design intent survives into the shipped product. When I approach a build, I think about what it needs to do and how people will use it before I think about implementation details. That produces clearer products, not just prettier screens.
...
For client work, I focus on web and product design plus frontend development. Separately, I designed and built Kota AI end to end, a multi-agent business operations platform for South African SMEs, which is the best public example of that depth. If your need is product-shaped (interfaces, workflows, MVP scope), I'm a strong fit; if you need a large enterprise AI platform team, we should talk about scope and collaboration model.

### "What is Kota AI?"
Kota AI is a multi-agent business operations platform I'm designing and building for South African small businesses, end to end, solo. It's meant to help SME owners handle operational work with business context (clients, pricing, brand voice) instead of generic chat. Currently in pre-launch testing.
...
I close the gap between design and development through technical understanding, not just collaboration skills. I can design complex product UX, build functional prototypes with real data, and mentor other designers. My background spans brand, print, and digital, giving me versatility most specialized designers lack. I think in systems and constraints, not just pixels. And I'm constantly learning by building real products, not just studying tools.
...
I am currently independent, focused on project-based client work across brand identity, web design, and frontend development, while building Kota AI and shipping RideNote. Before that, I was Lead UI Designer at Immersion Group in Cape Town from 2022-2024. I was retrenched at the end of 2024 when the company restructured. During my time there, I led a team of 3 designers, initiated an innovation project that created a new service offering, and shipped a production design system for a major bank.
