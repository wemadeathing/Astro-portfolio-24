...
ai_summary: "Delivered a fast, SEO-friendly B2B website in Astro as a modern alternative to a typical WordPress build."
image: "/images/work/ECOS Consulting _ Safety_ Health _ Environment.jpeg"
tags: ["Client Work", "B2B", "Environmental", "Astro"]
use_for_questions: ["Astro", "Performance", "SEO", "Client work", "B2B website", "Design-to-build"]
published: false
---
