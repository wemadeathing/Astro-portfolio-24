...
<ProjectStats
  stats={[
    { label: "Role", value: "Product designer, architect, solo builder" },
    { label: "Approach", value: "Designed in code with AI" },
    { label: "Type", value: "Operational AI product" },
    { label: "Focus", value: "Product thinking first" }
  ]}
/>
...
<ClickableImage
  ...
  alt="Kota dashboard showing the latest operational workspace interface"
  caption="The current dashboard brings guidance, operational signals, and next actions into one calmer workspace view."
/>
