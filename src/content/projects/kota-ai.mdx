...
description: "Designed and built a multi-agent AI operations platform for South African SMEs, from architecture to pre-launch product."
...
use_for_questions: ["Multi-agent systems", "AI architecture", "LangGraph", "RAG", "Knowledge base design", "Generative UI", "Agentic AI", "FastAPI", "Supabase", "SA SME", "Solo building"]
featured: true
published: true
order: 2
---
...
**Problem:** South African small business owners do not need another blank AI chat box. They need a system that understands their business context and turns work into usable output.

**Role:** architect, product designer, and solo builder.

**What shipped:** a multi-agent operations platform built on LangGraph, FastAPI, and Supabase, with a RAG knowledge base and a typed generative UI contract.

**Why it mattered:** the goal was to design AI around real operational constraints, not around novelty.

**Proof:** the platform is in pre-launch testing with core architecture, multi-tenant data design, and operational surfaces already in place.
