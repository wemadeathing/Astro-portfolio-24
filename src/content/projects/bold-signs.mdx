...
image: "/images/work/bold-signs-hero.webp"
...
outcome: "A gallery-driven website for a Cape Town signage studio, as considered as the work it sells. Live at boldsigns.co.za."
tldr:
  problem: "A studio producing premium physical brand work had no web presence to match. Most signage websites look like directories; this one had to look like a design studio."
  built: "A fast, gallery-driven Astro site with a bold typographic voice, real installation photography, and WhatsApp-first enquiries."
  result: "Live at boldsigns.co.za: a site that does the persuasion before a conversation starts."
stats:
  - label: "Role"
    value: "Design & Build"
  - label: "Client"
...
<ClickableImage
  src="/images/work/bold-signs-work.webp"
  alt="Bold Signs portfolio section showing selected signage projects"
  caption="The portfolio leads with real installations: vehicle wraps, retail signage, and wayfinding, in the order a buyer actually evaluates a studio."
/>
