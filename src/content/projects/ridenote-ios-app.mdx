...
**Problem:** mountain bikers forget which setup actually worked, and the existing tools are either too technical or too generic.

**Role:** product designer, brand designer, and solo builder.

**What shipped:** a local-first iOS app that lets riders log bike settings quickly, review what worked, and use a focused feedback model built around Grip, Feel, and Control.

**Why it mattered:** I wanted to prove full product ownership in a real shipping context, not just a prototype.

**Proof:** RideNote went from concept to App Store release in 30 days.

**Note:** This case study focuses on product and development decisions. A separate design case study will go deeper on branding, iconography, and interface craft.
