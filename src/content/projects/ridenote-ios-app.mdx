...
RideNote exists to answer one question in a parking lot: was it 26 or 28 PSI that felt better last month? I designed, branded, and built it solo, end to end, to prove full product ownership in a real release context, not a prototype. This case study covers the product and development decisions; a separate design case study will go deeper on branding, iconography, and interface craft.
...
<ClickableImage
  ...
  caption="First submission: rejected. Second submission: approved. The real process of releasing software."
/>
